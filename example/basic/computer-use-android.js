...
async function getScreenshot(android) {
    try {
        stepCounter++;
...
async function getDeviceScreenSize(android) {
    try {
...
async function handleModelAction(android, action) {
...
async function computerUseLoop(android, response) {
    while (true) {
